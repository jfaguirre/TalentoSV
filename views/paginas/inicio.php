...
<section class="section section-tertiary">
  <div class="container">
    ...
    <h2 class="sec-title fade d1">La forma más rápida y confiable de contratar</h2>
    <p class="sec-desc fade d2">Diseñamos una plataforma intuitiva que elimina las complejidades del reclutamiento tradicional.</p>
...
<!-- ── SECCIÓN DIVIDIDA: CANDIDATOS Y EMPRESAS ── -->
    ...
    <div class="split-grid">
      ...
      <div class="empresa-card fade">
        <div>
          ...
          <p class="empresa-desc">Gestiona vacantes, filtra candidatos calificados y comunícate directamente con el talento que necesitas en tiempo récord.</p>
          ...
          <div class="feature-list" style="margin-bottom:1.35rem">
            ...
            <div class="empresa-feature-item">
              <div class="empresa-check"><svg viewBox="0 0 12 12"><polyline points="2,6 5,9 10,3"/></svg></div>
              Dashboard de reclutamiento intuitivo
            </div>
          </div>
        </div>
...
<footer>
  <div class="container">
    <a class="footer-logo" href="#">Talento<span>ES</span></a>
      ...
      <div class="footer-social">
        <div class="social-btn" aria-label="Instagram">
          <a href="#" target="_blank" rel="noopener" style="display: inline-flex; align-items: center; justify-content: center; width: 24px; height: 24px; color: inherit; text-decoration: none;" >
            <svg class="niftybutton-instagram" data-donate="true" data-tag="ins" data-name="Instagram" viewBox="0 0 512 512" style="width: 18px; height: 18px; fill: currentColor;"><title>Instagram social icon</title>
